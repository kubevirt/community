...
In exceptional circumstances, such as when a repo is left without suffcient approvers, the project maintainers can pass a majority vote to add approvers that do not fulfil the requirements.
